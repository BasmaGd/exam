    ...
    public ResponseEntity<Etudiant> partialUpdateEtudiant(
        ...
        Optional<Etudiant> result = etudiantRepository
            ...
            .map(existingEtudiant -> {
                ...
                if (etudiant.getChoixDeCarriere() != null) {
                    existingEtudiant.setChoixDeCarriere(etudiant.getChoixDeCarriere());
                }
                if (etudiant.getProgressionAcademique() != null) {
                    existingEtudiant.setProgressionAcademique(etudiant.getProgressionAcademique());
                }
