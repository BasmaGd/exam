...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILIEREETUDES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILIEREETUDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILIEREETUDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILIEREETUDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILIEREETUDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILIEREETUDES actions', async () => {
      const expectedActions = [
        {
