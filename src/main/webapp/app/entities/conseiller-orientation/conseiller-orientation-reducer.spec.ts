...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './conseiller-orientation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSEILLERORIENTATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONSEILLERORIENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONSEILLERORIENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONSEILLERORIENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONSEILLERORIENTATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONSEILLERORIENTATION actions', async () => {
      const expectedActions = [
        {
