...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './carriere.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRIERE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARRIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARRIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARRIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARRIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARRIERE actions', async () => {
      const expectedActions = [
        {
